...
class PGDRegAttack(Attack, LabelMixin):
    def __init__(self, model, eps, steps, eps_lr, loss_fn=None, rand_init=True, clip_min=0.0, clip_max=1.0, ord=np.inf,
                 l1_sparsity=None, targeted=False, regular=0.0, sign=True, restart=1):
        super(PGDRegAttack, self).__init__(
    ...
    def perturb(self, x, y=None):
        ...
        rval = perturb_iterative_with_reg(
...
def perturb_iterative_with_reg(xvar, yvar, predict, nb_iter, eps, eps_iter, loss_fn,
