...
__all__ = ['mnist_dataloader', 'cifar10_dataloader', 'cifar100_dataloader', 'tiny_imagenet_dataloader', 'svhn_dataloader', 'stl10_dataloader', 'celeba_dataloader']
...
def mnist_dataloader(batch_size=64, data_dir='./data/', val_ratio=0.1):
    ...
    val_set = Subset(MNIST(data_dir, train=True, transform=test_transform, download=True), list(range(train_size, train_size + val_size)))
...
def cifar10_dataloader(batch_size=64, data_dir='./data/', val_ratio=0.1):
    ...
    val_set = Subset(CIFAR10(data_dir, train=True, transform=test_transform, download=True), list(range(train_size, train_size + val_size)))
...
def cifar100_dataloader(batch_size=64, data_dir='./data/', val_ratio=0.1):
    ...
    train_set = Subset(CIFAR100(data_dir, train=True, transform=train_transform, download=True), list(range(train_size)))
    val_set = Subset(CIFAR100(data_dir, train=True, transform=test_transform, download=True), list(range(train_size, train_size + val_size)))
...
def svhn_dataloader(batch_size=64, data_dir='./data/', val_ratio=0.1):
    ...
    val_set = Subset(SVHN(data_dir, split='train', transform=test_transform, download=True), list(range(train_size, train_size + val_size)))
